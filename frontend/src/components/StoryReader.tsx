  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-800 p-8 rounded-lg shadow-lg mb-8">
        {/* Spanish text */}
        <div className="mb-8">
          <h2 className="text-sm font-semibold text-slate-500 dark:text-slate-400 mb-4 uppercase tracking-wide">
            Spanish
          </h2>
          <p className="text-lg leading-relaxed text-slate-900 dark:text-white font-serif">
      ...
      <div className="flex gap-4">
        <button
          ...
          className="flex-1 py-3 px-4 border border-slate-300 dark:border-slate-600 text-slate-700 dark:text-slate-300 font-semibold rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          ← Previous
        </button>
